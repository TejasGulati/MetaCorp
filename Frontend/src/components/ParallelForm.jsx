    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-[#d1fae5] to-[#a7f3d0] rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {['name', 'industry', 'revenues', 'profits', 'market_value', 'employees', 'revenue_growth', 'profit_margin', 'costs'].map((field) => (
                        <div key={field}>
                            ...
                            {errors.company_data?.[field] && (
                                <p className="text-red-500 text-sm mt-1">{errors.company_data[field].message}</p>
                            )}
                        </div>
                    ))}
                </div>
                ...
                <div className="bg-white/50 p-6 grid grid-cols-3 gap-4 rounded-lg">
                    {['hiring_rate', 'rd_investment', 'market_expansion'].map((field) => (
                        <div key={field} className="bg-white/50 p-6 rounded-lg">
                            ...
                            {errors.base_decisions?.[field] && (
                                <p className="text-red-500 text-sm mt-1">{errors.base_decisions[field].message}</p>
                            )}
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 bg-white/50 p-6 rounded-lg">
                    ...
                    <div>
                        ...
                        />
                        {errors.num_years && (
                            <p className="text-red-500 text-sm mt-1">{errors.num_years.message}</p>
                        )}
                    </div>
                    <div>
                        ...
                        {errors.monte_carlo_sims && (
                            <p className="text-red-500 text-sm mt-1">{errors.monte_carlo_sims.message}</p>
                        )}
                    </div>
                </div>
